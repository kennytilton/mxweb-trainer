goog.loadModule(function(exports) {
  ...
  "sheet"), GET_PROPERTY_VALUE:prototypeMethodOrNull("CSSStyleDeclaration", "getPropertyValue"), SET_PROPERTY:prototypeMethodOrNull("CSSStyleDeclaration", "setProperty"), NAMESPACE_URI_GETTER:getterOrNull("Element", "namespaceURI") || getterOrNull("Node", "namespaceURI"),};
  ...
  function getElementNamespaceURI(element) {
    return genericPropertyGet(Methods.NAMESPACE_URI_GETTER, element, "namespaceURI", function(namespaceURI) {
  ...
  getNodeType:getNodeType, getParentNode:getParentNode, getChildNodes:getChildNodes, appendNodeChild:appendNodeChild, getCssPropertyValue:getCssPropertyValue, setCssProperty:setCssProperty, getElementNamespaceURI:getElementNamespaceURI, Methods:Methods,};
  return exports;
});

//# sourceMappingURL=goog.html.sanitizer.noclobber.js.map
