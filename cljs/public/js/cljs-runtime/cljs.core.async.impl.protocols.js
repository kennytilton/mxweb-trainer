...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26969 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26969(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26972 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26972(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26978 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26978(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26980 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26980(chan);
}
});
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26982(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26984 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26984(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26986 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26986(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26995 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26995(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26997 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26997(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_27010 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_27010(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_27012 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_27012(b);
}
});
