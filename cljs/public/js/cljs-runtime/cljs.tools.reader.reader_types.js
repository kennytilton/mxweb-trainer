...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26625 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26625(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26631 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26631(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26633 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26633(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26635 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26635(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26636 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26636(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26637 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26637(reader);
}
});
...
var G__26824 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26825 = s.append(c);
c = G__26824;
s = G__26825;
continue;
}
