...
var i_30096 = (0);
while(true){
if((i_30096 < arr.length)){
(arr[i_30096] = null);

var G__30098 = (i_30096 + (1));
i_30096 = G__30098;
continue;
} else {
}
...
var i_30113 = (self__.level + (1));
while(true){
if((i_30113 <= (new_level + (1)))){
(update[i_30113] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_30115 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30115[i]));
} else {
x__$2.forward.push((((i < links_30115.length))?(links_30115[i]):null));
}

if((i < links_30115.length)){
(links_30115[i] = x__$2);
} else {
links_30115.push(x__$2);
}
...
var i_30119 = (0);
while(true){
if((i_30119 <= self__.level)){
var links_30120 = (update[i_30119]).forward;
if((x__$1 === (((i_30119 < links_30120.length))?(links_30120[i_30119]):null))){
(links_30120[i_30119] = (x__$1.forward[i_30119]));

var G__30123 = (i_30119 + (1));
i_30119 = G__30123;
continue;
} else {
var G__30124 = (i_30119 + (1));
i_30119 = G__30124;
continue;
}
} else {
...
var G__30131 = nx;
var G__30132 = (level__$1 - (1));
x = G__30131;
level__$1 = G__30132;
continue;
} else {
var G__30133 = x;
var G__30134 = (level__$1 - (1));
x = G__30133;
level__$1 = G__30134;
continue;
}
