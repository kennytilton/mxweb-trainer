...
(defn welcome []
  (div {:style (str "display:flex"
    ...
    (p {}
      "mxWeb is a HTML/CSS GUI library powered by the "
      (a {:target "_blank"
    ...
    (p {}
      ...
      "<br>It comes with free tutorial support/solutions from the author of mxWeb, who "
      "can be found in the #Matrix channel of the "
      (a {:target "_blank"
    ...
    (ul {:style "padding:0;margin-left:36px"}
      (li "what you will learn;")
      (li "a relevant working example;")
      (li "a link to the mission source;")
      (li "a link to a supporting Wiki page."))
